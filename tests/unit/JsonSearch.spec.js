...
describe('JsonSearch.vue', () => {
    ...
    it('The albums are being correctly sorted alphabetically', () => {
        const newAlbums = [
            {
                album_img_url:
                    'https://img.discogs.com/-tStOMMJZ1Sz_kN40mTVSfXiH0Q=/fit-in/300x300/filters:strip_icc():format(jpeg):mode_rgb():quality(40)/discogs-images/R-5480381-1590849427-4840.jpeg.jpg',
                album_name: 'Un sol',
                album_price: '9,99',
            ...
            {
                album_img_url:
                    'https://upload.wikimedia.org/wikipedia/en/4/40/Luis_Miguel_CDs....jpg',
            ...
            {
                album_img_url:
                    'https://upload.wikimedia.org/wikipedia/en/7/78/On_and_On_%28Jack_Johnson_album_-_cover_art%29.jpg',
            ...
            {
                album_img_url:
                    'https://www.humonegro.com/wp-content/QUEEN-A-NIGHT-AT-THE-OPERA.png',
